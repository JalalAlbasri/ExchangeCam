...
package com.cavemanninja.exchangecam.camera;
...
import com.cavemanninja.exchangecam.PlanarYUVLuminanceSource;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = 5; // originally 240
	private static final int MIN_FRAME_HEIGHT = 5; // originally 240
	private static final int MAX_FRAME_WIDTH = 5; // originally 480
	private static final int MAX_FRAME_HEIGHT = 5; // originally 360
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			int min_frame_width = screenResolution.x * 1/6;
			int min_frame_height = screenResolution.y * 1/4;
			int max_frame_width = screenResolution.x * 2/3;
			int max_frame_height = screenResolution.y;

			int width = screenResolution.x * 1/6 + 65;
			...
			int leftOffset = ((screenResolution.x * 2/3) - width) /2 ;
	...
	//	public void setDashboardOpen(boolean open) {
	//		dashboardOpen = open;
	//	}
